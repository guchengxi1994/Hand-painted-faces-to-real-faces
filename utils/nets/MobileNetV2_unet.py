...
from utils.nets.MobileNetV2 import MobileNetV2, InvertedResidual


class MobileNetV2_unet(nn.Module):
    def __init__(self, pre_trained='weights/mobilenet_v2.pth.tar',device='cpu'):
        ...
        if pre_trained is not None:
            self.backbone.load_state_dict(torch.load(pre_trained,map_location=device))
